...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
...
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_notifications) {
  "use strict";
  ...
  socket.on('connect', function () {
    ...
    $('.signup__button').on('click', function (event) {
      ...
      var userLogin = $('input[name=login]').val();
      var userPassword = $('input[name=password]').val();
      var userPasswordConfirm = $('input[name=pasword_correct]').val();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var _default = {
    logNotification: function logNotification(login) {
      if (login.length > 50) {
        console.log("NO");
        return false;
      }
    },
    nameNotification: function nameNotification(name) {
      if (name.length > 255) {
        console.log("NO");
        return false;
      }
    },
    passNotification: function passNotification(password) {
